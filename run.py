...
parser.add_argument('--graph_path', type=str, default='sd.npy', help='data file')
...
parser.add_argument('--node_num', type=int, default=716, help='input node num')
...
parser.add_argument('--graph_mask', type=str, default=None, help='graph structure')
